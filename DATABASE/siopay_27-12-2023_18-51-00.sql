...
CREATE TABLE `beneficiaries` (
  ...
  `extra_datas` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(8, 3, 'King KC', '08038752155', 'NG', 'Brother', 'Male', 0, NULL, '2023-12-27 09:22:13', '2023-12-27 09:22:13'),
(9, 3, 'King KC', '08038752155', 'NG', 'Brother', 'Male', 0, NULL, '2023-12-27 09:25:09', '2023-12-27 09:25:09'),
(10, 3, 'King KC', '08038752155', 'NG', 'Brother', 'Male', 0, NULL, '2023-12-27 09:27:29', '2023-12-27 09:27:29'),
(11, 3, 'King KC', '08038752155', 'NG', 'Brother', 'Male', 0, NULL, '2023-12-27 09:27:43', '2023-12-27 09:27:43'),
(12, 3, 'King KC', '08038752155', 'NG', 'Brother', 'Male', 0, NULL, '2023-12-27 09:31:51', '2023-12-27 09:31:51'),
(13, 3, 'King KC', '08038752155', 'NG', 'Brother', 'Male', 0, NULL, '2023-12-27 09:32:08', '2023-12-27 09:32:08'),
(14, 3, 'KCCCC', '08038752155', 'NG', 'Brother', 'Male', 0, NULL, '2023-12-27 09:32:52', '2023-12-27 09:32:53'),
(15, 3, 'King KC', '08038752155', 'NG', 'Brother', 'Male', 0, '{\"customer_id\":\"cus_PGRKcaluzYHkR8\"}', '2023-12-27 09:34:43', '2023-12-27 09:34:49');
...
CREATE TABLE `beneficiary_accounts` (
  ...
  `beneficiary_account_number` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(9, 3, 3, '0262093375', 'Kefas Kingsley Gbutemu', 'GTBank', '00999', NULL, '2023-12-27 10:34:08', '2023-12-27 10:34:08'),
(10, 3, 3, '0262093375', 'Kefas Kingsley Gbutemu', 'GTBank', '00999', NULL, '2023-12-27 10:37:27', '2023-12-27 10:37:27'),
(11, 3, 15, '0262093375', 'Kefas Kingsley Gbutemu', 'GTBank', '00999', NULL, '2023-12-27 10:38:20', '2023-12-27 10:38:20'),
(12, 3, 15, '1111111112', 'Kefas Kingsley Gbutemu', 'GTBank', '00999', '{\"bank_account_id\":\"ba_1ORvX9CPuHcGXdFKN98IR2yY\"}', '2023-12-27 10:44:22', '2023-12-27 10:44:23');
...
CREATE TABLE `couriers` (
  ...
  `status` enum('active','inactive','decommisioned') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'active',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `e_u_funds_transfer_rates` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `s_country_eu` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `rx_country_eu` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `e_u_fund_transfer_orders` (
  ...
  `rx_surname` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rx_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rx_phone` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rx_email` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rx_bank_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rx_bank_routing_no` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rx_bank_swift_code` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rx_bank_account_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rx_bank_account_number` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rx_country` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `s_country` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `s_amount` double DEFAULT NULL,
  `rx_amount` double DEFAULT NULL,
  `tx_status` enum('unpaid','pending','done','rejected') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'unpaid',
...
CREATE TABLE `intl_fund_transfer_orders` (
  ...
  `rx_country` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `s_country` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rx_currency` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `kyc` (
  ...
  `selfie` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `proof_of_address_type_id` bigint(20) UNSIGNED DEFAULT NULL,
  `proof_of_address` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `kyc_level` int(11) NOT NULL DEFAULT 0,
  `status` enum('pending','approved','rejected') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `rejection_reason` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `personal_information` text COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `operation_countries` (
  ...
  `country_alpha2code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `country_alpha3code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `orders` (
  ...
  `status` enum('unpaid','placed','assigned','in_transit','delivered','cancelled') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'unpaid',
  ...
  `delivery_phone_alt` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `delivery_address1` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `delivery_address2` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `delivery_zip` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `pickup_phone_alt` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pickup_address1` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pickup_address2` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pickup_zip` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `cond_of_goods` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `val_of_goods` double(8,2) DEFAULT NULL,
  `val_cur` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `supported_banks` (
  `id` int(10) UNSIGNED NOT NULL,
  `bank_code` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `transactions` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `user_id` bigint(20) UNSIGNED NOT NULL,
  `transaction_type` enum('transfer') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'transfer',
  `beneficiary_id` bigint(20) UNSIGNED NOT NULL,
  ...
  `beneficiary_bank_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `beneficiary_bank_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `sending_country_code` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `receiving_country_code` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `transaction_status` enum('success','pending','failed','refunded') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  ...
  `payment_intent_data` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `webhook_data` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `transactions` (`id`, `user_id`, `transaction_type`, `beneficiary_id`, `beneficiary_account_id`, `transaction_id`, `transaction_amount`, `beneficiary_account_number`, `beneficiary_account_name`, `beneficiary_bank_name`, `beneficiary_bank_code`, `sending_country_code`, `receiving_country_code`, `received_amount`, `transaction_fee`, `payment_provider`, `transaction_status`, `transaction_reference`, `payment_intent`, `payment_intent_data`, `webhook_data`, `created_at`, `updated_at`) VALUES
(1, 3, 'transfer', 15, 12, 'SIOPAY-TXN658c15de3e0194.203337359503', 200, '0262093375', 'King KC', 'GTBank', '552019', NULL, NULL, NULL, NULL, 'stripe', 'pending', NULL, 'pi_3ORw3FCPuHcGXdFK1VJKVLLz_secret_AzUv1AP4s2F5a24bjbwlTLgjx', 'Stripe\\PaymentIntent JSON: {\n    \"id\": \"pi_3ORw3FCPuHcGXdFK1VJKVLLz\",\n    \"object\": \"payment_intent\",\n    \"amount\": 200,\n    \"amount_capturable\": 0,\n    \"amount_details\": {\n        \"tip\": []\n    },\n    \"amount_received\": 0,\n    \"application\": null,\n    \"application_fee_amount\": null,\n    \"automatic_payment_methods\": {\n        \"allow_redirects\": \"always\",\n        \"enabled\": true\n    },\n    \"canceled_at\": null,\n    \"cancellation_reason\": null,\n    \"capture_method\": \"automatic\",\n    \"client_secret\": \"pi_3ORw3FCPuHcGXdFK1VJKVLLz_secret_AzUv1AP4s2F5a24bjbwlTLgjx\",\n    \"confirmation_method\": \"automatic\",\n    \"created\": 1703679453,\n    \"currency\": \"usd\",\n    \"customer\": null,\n    \"description\": null,\n    \"invoice\": null,\n    \"last_payment_error\": null,\n    \"latest_charge\": null,\n    \"livemode\": false,\n    \"metadata\": {\n        \"beneficiary_account_id\": \"12\",\n        \"beneficiary_account_name\": \"King KC\",\n        \"beneficiary_account_number\": \"0262093375\",\n        \"beneficiary_bank_code\": \"552019\",\n        \"beneficiary_bank_name\": \"GTBank\",\n        \"beneficiary_id\": \"15\",\n        \"received_amount\": \"155\",\n        \"receiving_country_code\": \"NG\",\n        \"sending_country_code\": \"US\",\n        \"transaction_fee\": \"5\"\n    },\n    \"next_action\": null,\n    \"on_behalf_of\": null,\n    \"payment_method\": null,\n    \"payment_method_configuration_details\": {\n        \"id\": \"pmc_1LRcNhCPuHcGXdFKlIjueJUS\",\n        \"parent\": null\n    },\n    \"payment_method_options\": {\n        \"card\": {\n            \"installments\": null,\n            \"mandate_options\": null,\n            \"network\": null,\n            \"request_three_d_secure\": \"automatic\"\n        }\n    },\n    \"payment_method_types\": [\n        \"card\"\n    ],\n    \"processing\": null,\n    \"receipt_email\": null,\n    \"review\": null,\n    \"setup_future_usage\": null,\n    \"shipping\": null,\n    \"source\": null,\n    \"statement_descriptor\": null,\n    \"statement_descriptor_suffix\": null,\n    \"status\": \"requires_payment_method\",\n    \"transfer_data\": null,\n    \"transfer_group\": null\n}', NULL, '2023-12-27 11:17:34', '2023-12-27 11:17:34');
...
CREATE TABLE `transfer_intent` (
  ...
  `payment_intent_data` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `users` (
  ...
  `status` tinyint(1) NOT NULL DEFAULT 1,
  `user_type` enum('user','courier','dispatcher','admin','mobile') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'user',
...
(3, 'Samson Johnson', 'johnsonsamson23@gmail.com', NULL, '$2y$10$vof22O0ZRXn9fDWby9QP1.9UzEqh3ZC3ff5Fzywedf30FiHYDz7GK', 1, 'user', 0, NULL, '2023-12-23 15:50:45', '2023-12-23 15:50:45', NULL, NULL, '+412345767889464', 'IT', NULL),
...
CREATE TABLE `walk_in_customers` (
  ...
  `belfioreCode` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `doc_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `doc_num` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `doc_front` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `doc_back` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
