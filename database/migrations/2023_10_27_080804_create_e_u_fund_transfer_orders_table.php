...
class CreateEUFundTransferOrdersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('e_u_fund_transfer_orders', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('e_u_fund_transfer_orders');
    }
}
