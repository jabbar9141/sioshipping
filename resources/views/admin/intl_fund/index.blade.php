...
@section('content')
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title fw-semibold mb-4">All Intenational Fund Transfer Orders <a href="{{route('intl_fund_trasfer_order.create')}}" class="btn btn-primary" style="float: right">New Order</a></h5>
