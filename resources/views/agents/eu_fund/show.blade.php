@extends('admin.app')
@section('page_title', 'EU Fund Transfer Order Payment')
@section('content')
    <script src="https://js.stripe.com/v3/"></script>
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title fw-semibold mb-4">EU Fund Transfer Order Payment</h5>
                @include('admin.partials.notification')
                <hr>
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('eu_fund_trasfer_order.index') }}" class="btn btn-danger float-right"><i
                                    ...
                                    <table class="table table-bordered">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <th>Receiver Country/ Amount(&euro;)</th>
    ...
    <script>
        ...
        form.addEventListener('submit', async (event) => {
            ...
            const {
                ...
                elements,
                confirmParams: {
                    return_url: "{{ route('eu_fund_trasfer_order.show', $order->id) }}",
                },
            });
