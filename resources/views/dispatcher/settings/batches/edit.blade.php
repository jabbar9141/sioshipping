                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('batches.update', $batch->id) }}" method="post">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="ui-widget">
                                        ...
                                        <input type="hidden" name="origin_id" value="{{ $batch->location_id }}"
                                            id="origin_id">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <select name="status" id="status" class="form-control">
                                        <option value="assigned" {{(($batch->status == 'assigned') ? 'selected' : '')}}>Processing</option>
                                        <option value="in_transit" {{(($batch->status == 'in_transit') ? 'selected' : '')}}>In Transit</option>
                            ...
                            <br>
                            <button type="submit" onclick="return confirm('Are you sure you wish to update this batch, all changes set will affect all associated orders')" class="btn btn-primary"><i class="fa fa-save"></i> Save</button>
                        </form>
                    </div>
                </div>
            </div>
