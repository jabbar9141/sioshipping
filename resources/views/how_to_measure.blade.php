...
<body>
    ...
    <div class="jumbotron jumbotron-fluid mb-5">
        <div class="container text-center py-5">
            <h1 class="text-white display-3">{{__('nav.7')}}</h1>
            <div class="d-inline-flex align-items-center text-white">
                <p class="m-0"><a class="text-white" href="">Home</a></p>
                <i class="fa fa-circle px-3"></i>
                <p class="m-0">{{__('nav.7')}}</p>
            </div>
        </div>
    </div>
    <!-- Header End -->
        ...
        <div class="container">
            <div class="row align-items-left">
                <div class="col-11 text-md-start text-left py-8">
                    <h1 class="fw-normal fs-6 fs-xxl-7">{{__('nav.7')}} </h1>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-body">
                                        {!!trans('hompage.78')!!}
                                        <img src="{{ asset('landing/assets/img/reguler.png') }}" alt="regular pack"
                                            style="width: 90%">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-body">
                                        {!!trans('hompage.79')!!}
                                        <img src="{{ asset('landing/assets/img/irregular.png') }}" alt="irregular pack"
                                            style="width: 90%">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-body">
                                        {!!trans('hompage.80')!!}
                                        <img src="{{ asset('landing/assets/img/pallet.png') }}" alt="pallet pack"
                                            style="width: 90%">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-body">
                                        {!!trans('hompage.81')!!}
                                        <img src="{{ asset('landing/assets/img/cylinder.png') }}" alt="cylinder pack"
                                            style="width: 90%">
                                    </div>
                                </div>
                            </div>
