...
<body>
    ...
    <div class="jumbotron jumbotron-fluid mb-5">
        <div class="container text-center py-5">
            <h1 class="text-white display-3">{{__('hompage.50')}}</h1>
            <div class="d-inline-flex align-items-center text-white">
                <p class="m-0"><a class="text-white" href="">Home</a></p>
                <i class="fa fa-circle px-3"></i>
                <p class="m-0">{{__('hompage.50')}}</p>
            </div>
        </div>
    </div>
    <!-- Header End -->
        ...
        <div class="container">
            <div class="row align-items-left">
                <div class="col-11 text-md-start text-left py-8">
                    <h1 class="fw-normal fs-6 fs-xxl-7">{{__('hompage.50')}} </h1>
                        {{-- <h1 class="fw-bolder fs-6 fs-xxl-7 mb-2">Travel Tickets.</h1> --}}
                        {!!trans('hompage.107')!!}
